...
public enum ErrorCode {
    ...
    POST_EMPTY(1903, "Post is empty", HttpStatus.BAD_REQUEST),
    POST_ALREADY_SAVED(1904, "Post is already saved", HttpStatus.BAD_REQUEST),
    POST_NOT_SAVED(1905, "Post is not saved", HttpStatus.BAD_REQUEST),
    POST_NOT_OWNER(1906, "You are not the owner of this post", HttpStatus.FORBIDDEN),
    SHARED_POST_NOT_FOUND(1907, "Shared post was not found", HttpStatus.NOT_FOUND),
    POST_IMAGE_UPLOAD_FAILED(1908, "Post image upload failed", HttpStatus.BAD_GATEWAY),
